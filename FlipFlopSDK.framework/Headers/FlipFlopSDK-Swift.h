...
SWIFT_CLASS("_TtC11FlipFlopSDK20ACThumbnailGenerator")
@interface ACThumbnailGenerator : NSObject
...
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
///
- (void)replaceCurrentItemWithDataSourceURI:(NSString * _Nonnull)dataSourceURI;
/// pause player
- (void)pause;
/// resume player
- (void)resume;
...
@protocol FFConference
@property (nonatomic, strong) id <FFConferenceDelegate> _Nullable delegate;
@property (nonatomic, readonly) BOOL isConnected;
@property (nonatomic, readonly) NSInteger maxPublisher;
- (void)prepareWithPreview:(UIView * _Nonnull)preview config:(id <FFStreamConfig> _Nullable)config;
- (void)connect;
- (void)disconnect;
...
@protocol FFRTC
@property (nonatomic, strong) id <FFRTCDelegate> _Nullable delegate;
@property (nonatomic, readonly) BOOL isConnected;
- (void)prepareWithPreview:(UIView * _Nonnull)preview config:(id <FFStreamConfig> _Nullable)config;
- (void)connect;
- (void)disconnect;
